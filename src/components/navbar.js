...
const Navbar = () => {
	return (
		<nav className="sticky top-0 z-50 px-2 py-2.5 bg-white rounded border-gray-200 sm:px-4">
			<div className="container flex justify-between items-center mx-auto">
				<a href="/">
					<a aria-label="index" className="flex items-center">
						<span className="self-center text-2xl font-semibold whitespace-nowrap hover:animate-spin md:text-4xl font-title">
							RB
						</span>
					</a>
				</a>
				<div className="block w-auto">
					<ul className="flex flex-row mt-0 space-x-8 text-sm md:font-medium">
						<li>
							<a href="mailto:hello@robmakesgam.es">
								<a
									aria-label="email"
						...
						<li>
							<a href="https://github.com/robmakesgames">
								<a
									aria-label="github"
									className="block text-gray-700 bg-transparent">
									<svg
						...
						<li>
							<a href="https://www.instagram.com/robmakesgam.es">
								<a
